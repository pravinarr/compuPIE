...
public class ClientBean implements Serializable{
	...
	/**
	 * @return the occupatiion
	 */
	public String getOccupatiion() {
		return occupatiion;
	}
	/**
	 * @param occupatiion the occupatiion to set
	 */
	public void setOccupatiion(String occupatiion) {
		this.occupatiion = occupatiion;
	}
	/**
	 * @return the street
	 */
